...
void INTERFACE_draw(){
    ...
    INTERFACE_set_out_number(1, 0, DISPLAY_BRIGHTNESS);
    INTERFACE_set_out_number(2, 1, DISPLAY_BRIGHTNESS);

    INTERFACE_set_rect(0, 0, DISPLAY_BRIGHTNESS);
    INTERFACE_set_rect(1, 1, DISPLAY_BRIGHTNESS);
}
